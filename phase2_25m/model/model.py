...
Decoder-only Transformer | ~25M params | RoPE | SwiGLU | RMSNorm | Pre-LN

Spec locked per config:
  vocab_size=11000, hidden_size=512, n_layers=6, n_heads=8, head_dim=64,
  max_position_embeddings=1400, ffn_intermediate=1408, rope_theta=10000.0,
...
class PhysicsSLMConfig:
    ...
    max_position_embeddings: int = 1400
